...
angle_path = '../../saved_models/angle/mobilenetv2_20240507_128_new2'
speed_path = '../../saved_models/speed/mobilenetv2_20240505_128'
# converter = tf.lite.TFLiteConverter.from_keras_model(angle_model)
# Assuming angle_path points to the saved directory of your trained model
...
tflite_speed_path = '../../tflite_saved_models/speed/mobilenetv2_128.tflite'
